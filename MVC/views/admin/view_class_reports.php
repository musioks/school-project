<form class="form-horizontal" >
        <fieldset>
            <legend><i class="icon32 icon-gear"></i>Generate Reports</legend>
            <?php echo validation_errors(); ?>
        </fieldset>
</form>
<form method="post" action="<?php echo base_url();?>index.php/admin/class_reports" enctype="multipart/form-data">
